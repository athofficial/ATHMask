...
newState.TransactionController.transactions=transactions.map((txMeta)=>{if(!txMeta.status==='failed')return txMeta
if(txMeta.retryCount>0&&txMeta.retryCount<2){txMeta.status='submitted'
delete txMeta.err}
return txMeta})
return newState}