...
function migrateState(state){const keyringSubstate=state.KeyringController
const newState=extend(state,{PreferencesController:{selectedAddress:keyringSubstate.selectedAccount,},})
