...
module.exports=function(unapprovedTxs,unapprovedMsgs,personalMsgs,typedMessages,network){log.debug('tx-helper called with params:')
...
allValues=allValues.sort((a,b)=>{return a.time>b.time})
return allValues}